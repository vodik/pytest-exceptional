# -*- coding: utf-8 -*-
#
# pytest-exceptional documentation build configuration file, created by
...
project = u'pytest-exceptional'
copyright = u'2015, Simon Gomizelj'
author = u'Simon Gomizelj'
...
man_pages = [
    (master_doc, 'pytest-cookiecutterplugin_name', u'pytest-exceptional Documentation',
     [author], 1)
]
